    ...
    <div class=box>
        ...
        <h1><u>Edit Profile </u></h1>
            <form action="#" method="post" class=form>
                Username:<input type="text" name='username' class=inputbox value="<?php echo $name?>"><br><br>
                E-mail:<input type="text" name='email' class=inputbox value="<?php echo $email?>"><br><br>
                Phone Number:<input type="text" name='phone' class=inputbox value="<?php echo $phone?>"><br><br>
                Address:<input type="text" name='address' class=inputbox value="<?php echo $address?>"><br><br>
                Password:<input type="password" name='password' class=inputbox value="<?php echo $password?>"><br>
